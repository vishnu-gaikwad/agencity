...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            $sql = "SELECT COUNT(id) FROM tbl_advisers";
            ...
            if ($total_records > 0) {
                ...
                if ($total_pages <= 5 || $page <= 4) {
                    for ($i = 1; $i <= 5 && $i <= $total_pages; $i++) {
                        ...
                        $pagLink .= "<a href='adviserlist.php?page=" . $i . "'>" . $i . "</a></li>";
                    }
                ...
                $sql = "SELECT * FROM tbl_advisers LIMIT $start_from, $limit ";
                //}
                ...
                echo "<tr> <th>ID</th> <th>First Name</th> <th>Last Name</th><th>CP</th><th>City</th><th>Phone</th> <th></th> <th></th></tr>";
                ...
                while ($row = mysqli_fetch_assoc($rs_result2)) {
					...
					echo "<td><a onClick=\"javascript: return confirm('Please confirm deletion');\" href='delete_adviser.php?id=".$row['id']."'>Delete</a></td>";
                ...
                if ($total_pages != 0) {
                    echo $pagLink . '<li><a>....</a></li><li><a href=adviserlist.php?page=' . $total_pages . ">" . $total_pages . "</a></li></ul>";
                }
            ...
            <p><a href="add_new.php">Add a new record</a></p>
